...
static cl::OptionCategory MyToolCategory("Astparser Options");
...
class MyASTVisitor : public RecursiveASTVisitor<MyASTVisitor> {
	public:
        ...
        //     //raw_ostream S(SStr);
        //     //PrintingPolicy Policy(TheContext.getLangOpts());
		// 	//llvm::outs() << s->getStmtClassName() << "\t";
        //     // s->printPretty(llvm::outs(), nullptr, TheContext.getPrintingPolicy());
        //     //llvm::outs() << s->getSourceRange().printToString(TheContext.getSourceManager()) << "\n";
        //     //llvm::outs() << "\n";
        //     return true;
		// }
        ...
        //             llvm::outs() << d->isThisDeclarationReferenced() << "\n";
	...
	public:
        ...
        void HandleTranslationUnit(ASTContext &Ctx) override{
            ...
            for(DeclContext::decl_iterator b=Decls.begin(), e=Decls.end(); b!=e; ++b) {
                ...
                if(std::regex_search(filename, std::regex("DataSets"))){
                    //llvm::outs() << filename << "\n";
                    Visitor.TraverseDecl(*b);
                }
                // llvm::outs() << filename << "\n";
                ...
                // }
                // else if(std::regex_search(filename, std::regex("DataSets"))){
                //     //llvm::outs() << filename << "\n";
                //     Visitor.TraverseDecl(*b);
                // }
                // else {
                //     llvm::errs() << "STD Libiary.\n";
                // }
                // else{
                //     //Visitor.TraverseDecl(*b);
                // }
